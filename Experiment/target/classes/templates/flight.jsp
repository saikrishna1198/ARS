  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <form class="container-fluid justify-content-start">
          <a class="nav-link active" aria-current="page" href="login"><button class="btn btn-outline-success me-2" type="button"><i class="ri-account-circle-fill"></i> Sign In/Up</button></a>
          </form>
        </li>
      </ul>
    </div>
    ...
    function searchFlights() {
        ...
        var flightsData = [
            ...
            { flightNumber: "Indigo", departure: "Vijayawada", destination: "Delhi", price: 12000},
            { flightNumber: "AirBus", departure: "Vijayawada", destination: "Madras", price: 5000 },
            { flightNumber: "BharatPlane", departure: "Vijayawada", destination: "Goa", price: 6969.69 },
